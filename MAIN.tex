...
We assess quantitative performance in five classification tasks,
paying particular attention to a binary and a four multi-class
...
This has motived the use of machine learning algorithms to recognize
